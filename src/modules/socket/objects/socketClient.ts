...
class SocketClient implements ISocketClient {
  ...
  private readonly transmissionService: TransmissionsModule.interfaces.ITransmissionService = container.get(TransmissionsModule.DI_TYPES.TransmissionService)
