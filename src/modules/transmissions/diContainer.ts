...
container
	.bind<IMessageTransmissionRepo>(DI_TYPES.MessageTransmissionRepo)
	.to(MessageTransmissionRepo)
container
	.bind<IFileTransmissionRepo>(DI_TYPES.FileTransmissionRepo)
	.to(FileTransmissionRepo)
container
	.bind<ITransmissionService>(DI_TYPES.TransmissionService)
	.to(TransmissionService)
