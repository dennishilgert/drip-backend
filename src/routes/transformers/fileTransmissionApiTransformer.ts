...
class FileTransmissionApiTransformer extends BaseTransformer {
  ...
  transform (): TransmissionsModule.types.ITransformedFileSending {
    ...
    const transformedFileTransmission: TransmissionsModule.types.ITransformedFileSending = _.pick(this.fileTransmission, pickProperties) as TransmissionsModule.types.ITransformedFileSending
